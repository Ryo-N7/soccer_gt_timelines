...
createTimelineTableGT <- function(
  ...
  match_gt_xG_timeline <- 
    ...
    tab_header(   
      title = gt::html(glue::glue("<span style='font-size:35px'>({home_stats$xG} xG)</span> <b style='color:{home_color}; font-size:55px'>{home_team}</b> <span style='font-size:70px'>{home_stats$GOALS} - </span><span style='font-size:70px'>{away_stats$GOALS}</span> <b style='color:{away_color}; font-size:55px'>{away_team}</b> <span style='font-size:35px'>({away_stats$xG} xG)"),
      #subtitle = gt::html(glue::glue("<span style='font-size:40px'>Premier League 2020-2021: Matchday 1 ({match_date})</span>"))
      subtitle = gt::html(glue::glue("<p><img src='Liverpool_FC.png' alt='LFC' style='width:190px;vertical-align:middle;margin:50px 150px 50px 100px;'><span style='font-size:40px'>Premier League 2020-2021: Matchday 1 ({match_date})</span><img src='Leeds_United_FC.png' alt='LUFC' style='width:190px;vertical-align:middle;margin:50px 100px 50px 150px;'></p>"))
        )
    ) %>% 

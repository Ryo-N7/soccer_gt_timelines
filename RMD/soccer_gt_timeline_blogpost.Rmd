...
The variables created at the bottom will be used throughout the code and are usually appended to the data frames we'll be creating and cleaning. Make sure that the "home_team" and "away_team" variables are the exact names for the teams on understat.com but without the `_` symbols. 
...
9. Arrange the rows by `id` so that shots are in order chronologically.

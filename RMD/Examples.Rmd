...
gtsave(match_gt_xG_timeline, here::here(glue("RMD/output/{hom}{awa}_match_gt_shotmap_final.html")))
```

```{r}
markdown::rpubsUpload(title = glue::glue("gt-{hom}{awa}_match_gt_shotmap.html"), 
                      htmlFile = here::here(glue::glue("RMD/output/{hom}{awa}_match_gt_shotmap_final.html")))
```
